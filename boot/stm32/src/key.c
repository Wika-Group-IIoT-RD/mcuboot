...
const unsigned char ecdsa_pub_key[LENGTH_PUB_KEY] = {
...
const unsigned int ecdsa_pub_key_len = LENGTH_PUB_KEY;

unsigned char __attribute__((section(".keys"))) enc_priv_key[LENGTH_PRIVATE_KEY] = {
